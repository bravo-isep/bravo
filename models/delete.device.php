...
if($type == '1')
{
    try{
        ...
        $sql = "DELETE FROM ac_sys WHERE `ac_sys`.`idac_sys` = $id_device";
...
}else if($type == '2')
{
    try{
        ...
        $sql = "DELETE FROM lighting_sys WHERE `lighting_sys`.`idlighting_sys` = $id_device";
...
}else
{
    try{
        ...
        $sql = "DELETE FROM sensor WHERE `sensor`.`idsensor` = $id_device";
