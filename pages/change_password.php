...
<body>
    <div id="change_password">
        ...
        <form method="post">
            <input type="password" required="required" placeholder="Old Password" name="op" style="display:none"></br> <!--this line will hide if user visit this page from the link in the email for reseting password-->
